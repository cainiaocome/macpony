...
session. Request bytes are accumulated in a bounded chunk table and joined
once at the newline; the server does not create a new progressively larger
Lua string for every byte.
